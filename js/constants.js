...
var gemLifetimeMin = 30;	// min number of seconds a gem stays onscreen
var gemLifetimeMax = 60;	// max number of seconds a gem stays onscreen
var gemTypes = 3;			// number of gem types
var maxGems = 10;			// number of simultaneous gems allowed